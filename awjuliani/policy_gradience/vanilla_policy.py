# 2-b vanilla policy gradient agent
...
class agent():
	def __init__(self, lr, s_size, a_size, h_size):
		...
		# the next six lines established the training proceedure. we feed the reward and chosen action into the network to 
...
with tf.Session() as sess:
	...
	gradBuffer = sess.run(tf.trainable_variables()) # gradBuffer存储的是各个变量？
